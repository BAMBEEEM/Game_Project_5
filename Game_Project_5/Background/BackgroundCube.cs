...
namespace Game_Project_5.Background
{
    ...
    public class BackgroundCube
    {
        ...
        public void InitializeVertices()
        {
            ...
            new VertexPositionColor() { Position = new Vector3(-3,  3, -3), Color = Color.LightBlue },
            new VertexPositionColor() { Position = new Vector3( 3,  3, -3), Color = Color.Crimson },
            new VertexPositionColor() { Position = new Vector3(-3, -3, -3), Color = Color.CornflowerBlue },
            new VertexPositionColor() { Position = new Vector3( 3, -3, -3), Color = Color.LightCoral },
            new VertexPositionColor() { Position = new Vector3(-3,  3,  3), Color = Color.PaleGreen },
            new VertexPositionColor() { Position = new Vector3( 3,  3,  3), Color = Color.DarkKhaki },
            new VertexPositionColor() { Position = new Vector3(-3, -3,  3), Color = Color.PaleTurquoise },
            new VertexPositionColor() { Position = new Vector3( 3, -3,  3), Color = Color.MediumTurquoise }
        };
        ...
        void InitializeEffect()
        {
            ...
            effect.View = Matrix.CreateLookAt(
                new Vector3(0, 0, 0), // The camera position
        ...
        public BackgroundCube(Game1 game)
        {
            this.game = game;
            InitializeVertices();
            InitializeIndices();
        ...
        public void Update(GameTime gameTime)
        {
            ...
            effect.View = Matrix.CreateRotationZ(angle) * Matrix.CreateLookAt(
                new Vector3(-1, 0, 0),
                Vector3.Zero,
                Vector3.Up
            );
