...
namespace Game_Project_5.Sprites
{
    ...
    {
        public Vector2 Position= new Vector2(-143, 582);
        ...
        */
        ...
        {
            _attackTexture = content.Load<Texture2D>("1st");
        ...
        public void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            if (!Dead)
            {
                if (Shooting)
                {
                    if (_animationTimer > _animationSpeed)
                    {
                        ...
                        else if (_animationFrame < 0 || _animationFrame >= 5)
                            _animationFrame = 0;
            ...
            source = new Rectangle(0, _animationFrame * 44, 450, 44);
            ...
            if (Show)
            spriteBatch.Draw(_attackTexture, Position, source, Color, 0, origin, 2.8f, SpriteEffects.FlipHorizontally, 0.2f);
